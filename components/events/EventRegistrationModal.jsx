...
export const EventRegistrationModal = (props) => {
    const { setRegistrationModal } = useContext(RegistrationModalContext);
    return (
            ...
            <div className="bg-white rounded-lg w-5/6 sm:w-3/4 xl:w-1/2">
                <div className="flex flex-col items-start p-4">
                    <div className="flex items-center w-full">
                        ...
                        <button onClick={() => setRegistrationModal(-1)} className="ml-auto fill-current text-gray-700 w-6 h-6 cursor-pointer">
